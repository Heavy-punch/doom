...
export const historyUser = () => async (dispatch, getState) => {
    ...
    try {
        ...
        dispatch({ type: USER_HISTORY_SUCCESS, payload: data.data });
        // localStorage.setItem('userInfo', JSON.stringify(data.data));
    } catch (error) {
        dispatch({
